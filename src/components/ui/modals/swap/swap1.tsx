...
const SwapFirstTokenModal = () => {
    ...
    return (
        <Fragment>
            ...
            />
            <dialog id="token_list_modal_1" className="modal backdrop-blur">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="p-3">
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
                                <div className="btn btn-ghost flex flex-row items-center gap-3 rounded-md bg-gradient-orange px-[10px] py-[8px]">
                                    <Image
                                        loading="lazy"
                                        priority={false}
                                ...
                                <div className="btn btn-ghost flex flex-row items-center gap-3 rounded-md bg-gradient-dark px-[10px] py-[8px]">
                                    <Image
                                        loading="lazy"
                                        priority={false}
                                        src={'/assets/icons/tokens/eth.svg'}
